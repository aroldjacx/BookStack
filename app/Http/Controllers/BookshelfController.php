...
class BookshelfController extends Controller
{
    ...
    public function __construct(BookshelfRepo $bookshelfRepo, ShelfContext $entityContextManager, ImageRepo $imageRepo, BookRepo $bookRepo, ChapterRepo $chapterRepo)
    {
